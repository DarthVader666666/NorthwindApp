...
namespace Northwind.Data.Migrations
{
    ...
    [Migration("20240428211814_Bind_Customers_and_Users")]
    partial class Bind_Customers_and_Users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.NorthwindUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.NorthwindUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Northwind.Data.Entities.Customer", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.NorthwindUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
