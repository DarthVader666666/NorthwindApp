...
namespace Northwind.Data.Migrations
{
    ...
    [Migration("20240910123632_Renamed_Employee_table_and_FK_to_Seller")]
    partial class Renamed_Employee_table_and_FK_to_Seller
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    ...
                    b.HasKey("SellerId", "TerritoryId");

                    SqlServerKeyBuilderExtensions.IsClustered(b.HasKey("SellerId", "TerritoryId"), false);

                    b.HasIndex("TerritoryId");

                    b.ToTable("SellerTerritories", (string)null);
                });
            ...
            modelBuilder.Entity("Northwind.Data.Entities.AlphabeticalListOfProduct", b =>
                {
            ...
            modelBuilder.Entity("Northwind.Data.Entities.CurrentProductList", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Northwind.Data.Entities.CustomerDemographic", b =>
                {
                    b.Property<string>("CustomerTypeId")
                        .HasMaxLength(10)
                        .HasColumnType("nchar(10)")
            ...
            modelBuilder.Entity("Northwind.Data.Entities.NorthwindUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Northwind.Data.Entities.Order", b =>
                {
                    ...
                    b.HasIndex(new[] { "SellerId" }, "SellersOrders");
            ...
            modelBuilder.Entity("Northwind.Data.Entities.OrderDetailsExtended", b =>
                {
                    b.Property<float>("Discount")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Northwind.Data.Entities.OrderSubtotal", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("Northwind.Data.Entities.OrdersQry", b =>
                {
                    b.Property<string>("Address")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
            ...
            modelBuilder.Entity("Northwind.Data.Entities.ProductsAboveAveragePrice", b =>
                {
                    b.Property<string>("ProductName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("Northwind.Data.Entities.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(15)
            ...
            modelBuilder.Entity("Northwind.Data.Entities.QuarterlyOrder", b =>
                {
                    b.Property<string>("City")
                        .HasMaxLength(15)
                        .HasColumnType("nvarchar(15)");
            ...
            modelBuilder.Entity("Northwind.Data.Entities.SalesByCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int")
                        .HasColumnName("CategoryID");
            ...
            modelBuilder.Entity("Northwind.Data.Entities.SalesTotalsByAmount", b =>
                {
                    b.Property<string>("CompanyName")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("Northwind.Data.Entities.SummaryOfSalesByYear", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("CustomerCustomerDemo", b =>
                {
                    b.HasOne("Northwind.Data.Entities.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .IsRequired()
                        .HasConstraintName("FK_CustomerCustomerDemo_Customers");

                    b.HasOne("Northwind.Data.Entities.CustomerDemographic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeTerritory", b =>
                {
                    b.HasOne("Northwind.Data.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("SellerId")
                        .IsRequired()
                        .HasConstraintName("FK_SellerTerritories_Sellers");

                    b.HasOne("Northwind.Data.Entities.Territory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Northwind.Data.Entities.NorthwindUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Northwind.Data.Entities.Employee", b =>
                {
                    b.HasOne("Northwind.Data.Entities.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("Northwind.Data.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Northwind.Data.Entities.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Northwind.Data.Entities.Territory", b =>
                {
                    b.HasOne("Northwind.Data.Entities.Region", "Region")
